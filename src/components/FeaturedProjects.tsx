  ...
  const featuredProjects = [
    {
      ...
      description: "Deep learning system for automated medical image analysis using CNNs and Vision Transformers. Achieved 94.2% accuracy in detecting lung cancer from CT scans, deployed in 15+ hospitals.",
    ...
    },
    {
      ...
      description: "ML-powered fraud detection system processing 1M+ transactions daily. Uses ensemble methods and real-time feature engineering to detect fraudulent activities with sub-100ms latency.",
    ...
    },
    {
      ...
      description: "Advanced chatbot using transformer models and RAG architecture. Handles customer support queries with 85% resolution rate, reducing human intervention by 60%.",
